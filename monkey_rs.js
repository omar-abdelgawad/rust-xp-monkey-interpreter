...
const MonkeyVMFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_monkeyvm_free(ptr >>> 0, 1));
/**
 * Bytecode VM exposed to WASM.
 * Supports incremental execution via `compile()` + `step()` loop.
 */
export class MonkeyVM {

    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        MonkeyVMFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_monkeyvm_free(ptr, 0);
    }
    /**
    ...
    constructor() {
        ...
        MonkeyVMFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
     ...
     */
    step() {
        const ret = wasm.monkeyvm_step(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     * Drop the inner VM.
     */
    reset() {
        wasm.monkeyvm_reset(this.__wbg_ptr);
    }
    /**
    ...
    result() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.monkeyvm_result(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    compile(code) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.monkeyvm_compile(this.__wbg_ptr, ptr0, len0);
        return ret !== 0;
    }
    /**
    ...
    evaluate(code) {
        ...
        try {
            const ptr0 = passStringToWasm0(code, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.monkeyvm_evaluate(this.__wbg_ptr, ptr0, len0);
            deferred2_0 = ret[0];
            deferred2_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('monkey_rs_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
